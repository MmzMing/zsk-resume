...
function SheetContent({
  ...
  const sideClasses = {
    ...
    bottom: "inset-x-0 bottom-0 h-auto w-full data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
  }
  ...
  return (
    <DialogPrimitive.Portal data-slot="sheet-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in duration-300",
          sideClasses[side],
          className
        )}
        {...props}
